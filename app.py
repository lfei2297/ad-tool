...
# 页面配置
# ==========================
st.set_page_config(page_title="广告素材生成工具 v12", page_icon="🚀", layout="wide")
st.title("🚀 广告素材批量生成工具 (V12 全功能旗舰版)")
...
# 💡 模块三专属：自定义分组规模
GROUP_SIZE = st.sidebar.number_input("📦 分组规模 (每组数量)", min_value=1, value=30)
